...
const CASES = [
  {
    ...
    webp: '/images/case-serebryany-bor.webp',
  ...
  },
  {
    ...
    webp: '/images/case-life-varshavskaya.webp',
  ...
  },
  {
    ...
    webp: '/images/case-primavera.webp',
        ...
        <div className="cards-grid md:grid-cols-3">
          {CASES.map((caseItem, index) => {
            ...
            return (
              <motion.article
                key={caseItem.name}
                className="card-shell group rounded-[26px] border border-border bg-card/90 shadow-[0_16px_48px_rgba(0,0,0,0.35)] transition-colors duration-300 hover:border-accent/28"
                {...motionProps}
              >
                <div className={`relative h-52 sm:h-56 shrink-0 overflow-hidden bg-gradient-to-br ${caseItem.gradient}`}>
                  <OptimizedImage
                    webpSrc={caseItem.webp}
                    fallbackSrc={caseItem.image}
                    alt=""
                  ...
                  />
                  <div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-background/90 via-background/20 to-transparent" aria-hidden />
                </div>
