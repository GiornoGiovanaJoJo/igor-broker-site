          ...
          >
            ...
            <div className="space-y-6">
              ...
              <p className="text-[18px] sm:text-[19px] text-muted-foreground leading-relaxed font-light max-w-xl">
                Конфиденциональный подбор и сценарии платежа без лишних визитов в офисы застройщика. Москва и область: семейная ипотека,
                trade-in и сопровождение сделки на уровне private banking.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <motion.button
                ...
                className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-2xl border border-border bg-card/40 hover:bg-card/70 hover:border-accent/30 text-primary transition-all duration-300"
                whileHover={{ scale: 1.01 }}
                whileTap={{ scale: 0.99 }}
              >
            ...
            <div className="flex items-center gap-8 pt-4 flex-wrap">
              {[
                { value: '10+', label: 'лет в банках' },
                { value: '200+', label: 'подборов' },
                ...
                <React.Fragment key={i}>
                  ...
                  >
                    <span className="text-[32px] sm:text-[36px] font-semibold text-accent font-display">
                      {stat.value}
                    </span>
